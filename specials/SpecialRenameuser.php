...
class SpecialRenameuser extends SpecialPage {
	...
	public function execute( $par ) {
		...
		$newnamePar = trim( str_replace( '_', ' ', $request->getText( 'newusername', $usernames[1] ) ) );
		// Force uppercase of newusername, otherwise wikis with wgCapitalLinks=false can create lc usernames
		$newusername = Title::makeTitleSafe( NS_USER, $wgContLang->ucfirst( $request->getText( 'newusername', $usernames[1] ) ) );
