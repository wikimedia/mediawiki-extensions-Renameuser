...
kerem kerê agêrê newe ra tesel bıkerê, bıcerbnê',
	...
	'log-description-renameuser' => 'Nê qeydê vurnayış dê name dê krberi yê',
...
$messages['fr'] = array(
	...
	'logentry-renameuser-renameuser' => "$1 {{GENDER:$2|a renommé}} l'utilisateur $4 ({{PLURAL:$6|$6 modification|$6 modifications}}) en $5", # Fuzzy
...
Volva atrás e inténteo de novo.',
	...
	'logentry-renameuser-renameuser' => '$1 {{GENDER:$2|mudou o nome}} do usuario $4 ({{PLURAL:$6|$6 edición|$6 edicións}}) a $5', # Fuzzy
...
$messages['it'] = array(
	...
	'logentry-renameuser-renameuser' => "$1 {{GENDER:$2|ha rinominato}} l'utente $4 (con {{PLURAL:$6|$6 modifica|$6 modifiche}}) in $5", # Fuzzy
...
Вратете се и обидете се повторно.',
	...
	'logentry-renameuser-renameuser' => '$1 го {{GENDER:$2|преименуваше}} корисникот $4 ({{PLURAL:$6|$6 уредување|$6 уредувања}}) во $5', # Fuzzy
...
$messages['vi'] = array(
	...
	'logentry-renameuser-renameuser' => '{{GENDER:$2}}$1 đã đổi tên thành viên $4 ($6 lần sửa đổi) thành $5', # Fuzzy
