...
Bitte nochmal versuchen.',
	...
	'logentry-renameuser-renameuser' => '$1 {{GENDER:$2|hat}} Benutzer „$4“ (mit {{PLURAL:$5|einer Bearbeitung|$6 Bearbeitungen}}) in „$5“ umbenannt',
...
Źi pšosym slědk a wopytaj hyšći raz.',
	...
	'logentry-renameuser-renameuser' => '$1 jo wužywarja $4 ({{PLURAL:$5|$6 změna|$6 změnje|$6 změny|$6 změnow}}) do $5 {{GENDER:$2|pśemjenił|pśemjenił}}',
...
$messages['fr'] = array(
	...
	'logentry-renameuser-renameuser' => "$1 {{GENDER:$2|a renommé}} l'utilisateur $4 ({{PLURAL:$5|$6 modification|$6 modifications}}) en $5",
...
Volva atrás e inténteo de novo.',
	...
	'logentry-renameuser-renameuser' => '$1 {{GENDER:$2|mudou o nome}} do usuario $4 ({{PLURAL:$5|$6 edición|$6 edicións}}) a $5',
...
$messages['hsb'] = array(
	...
	'logentry-renameuser-renameuser' => '$1 je wužiwarja $4 ({{PLURAL:$5|$6 změna|$6 změnje|$6 změny|$6 změnow}}) do $5 {{GENDER:$2|přemjenował|přemjenował}}',
...
$messages['it'] = array(
	...
	'logentry-renameuser-renameuser' => "$1 {{GENDER:$2|ha rinominato}} l'utente $4 (con {{PLURAL:$5|$6 modifica|$6 modifiche}}) in $5",
...
戻ってから再度試してください。',
	...
	'logentry-renameuser-renameuser' => '$1 が $4 ({{PLURAL:$5|$6 編集}}) の利用者名を $5 に{{GENDER:$2|変更しました}}',
...
뒤로 가서 다시 시도하세요.',
	...
	'logentry-renameuser-renameuser' => '$1 사용자가 $4 사용자({{PLURAL:$5|편집 $6회}})의 이름을 $5(으)로 {{GENDER:$2|바꾸었습니다}}',
...
Вратете се и обидете се повторно.',
	...
	'logentry-renameuser-renameuser' => '$1 го {{GENDER:$2|преименуваше}} корисникот $4 ({{PLURAL:$5|$6 уредување|$6 уредувања}}) во $5',
